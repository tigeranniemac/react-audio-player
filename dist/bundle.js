...
/***/ function(module, exports, __webpack_require__) {
	...
	var DEFAULT_LISTEN_EVENT_INTERVAL = 10000;

	var ReactAudioPlayer = _react2.default.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    audio.addEventListener('play', function (e) {
	      ...
	      _this.props.playerActions.play(audio.currentTime, _this.props.episodeId);
	      _this.props.onPlay(audio.currentTime);
	    });

	    // When unloading the audio player (switching to another src)
	    audio.addEventListener('abort', function (e) {
	      _this.clearListenTrack();
	      _this.props.onAbort(audio.currentTime);
	    });

	    // When the file has finished playing to the end
	    audio.addEventListener('ended', function (e) {
	      _this.clearListenTrack();
	      _this.props.onEnd(audio.currentTime);
	    });

	    // When the user pauses playback
	    audio.addEventListener('pause', function (e) {
	      _this.clearListenTrack();
	      _this.props.onPause(audio.currentTime);
	    });

	    // When the user drags the time indicator to a new time
	    audio.addEventListener('seeked', function (e) {
	      _this.clearListenTrack();
	      _this.props.onSeeked(audio.currentTime);
	    });
	  },
